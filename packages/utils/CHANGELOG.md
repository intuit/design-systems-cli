...
- Update auto to v10 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency @types/classnames to v2.2.11 ([@renovate-bot](https://github.com/renovate-bot))
...
- update utils readme ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- upgrade typescript eslint parser+plugin ([@hipstersmoothie](https://github.com/hipstersmoothie))

...
- Update dependency ts-loader to v8.0.17 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency colorette to v1.2.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency title-case to v3.0.3 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency cli-spinners to v2.5.0 ([@renovate-bot](https://github.com/renovate-bot))
...
Thank you, null[@edgarsherman](https://github.com/edgarsherman), for all your work!
...
- fix: issue committing on windows (edgar_sherman@intuit.com)
...
- Update dependency @types/inquirer to v7.3.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency ts-loader to v8.0.3 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency webpack-cli to v3.3.12 ([@renovate-bot](https://github.com/renovate-bot))
...
- update templates: babel runtime, playroom snippet, story name separator ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- add storybook config to templates ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency ts-loader to v8 ([@renovate-bot](https://github.com/renovate-bot))

...
- fix esm css.js output ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency colorette to v1.2.2 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency typescript to v4.2.2 ([@hipstersmoothie](https://github.com/hipstersmoothie))
- Update babel ([@hipstersmoothie](https://github.com/hipstersmoothie))
- Update dependency pretty-bytes to v5.6.0 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency babel-plugin-styled-components to v1.12.0 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency @types/babel__code-frame to v7.0.2 ([@renovate-bot](https://github.com/renovate-bot))
- Merge branch 'master' into feature/issue-533-update-some-types ([@vfreitas-](https://github.com/vfreitas-))
- chore(typings): remove and update some types ([@vfreitas-](https://github.com/vfreitas-))
...
- add babel plugin macros to default build config ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- fix css source map generation ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Use bool flag to denote the main file ([@adierkens](https://github.com/adierkens))
...
- add semicolon ([@tylerkrupicka](https://github.com/tylerkrupicka))
- fix localpostcss loading i think ([@tylerkrupicka](https://github.com/tylerkrupicka))
- do css transforms serially to avoid writing to the same file at the same time ([@hipstersmoothie](https://github.com/hipstersmoothie))
- try minify promise api ([@tylerkrupicka](https://github.com/tylerkrupicka))
- document multi-build ([@tylerkrupicka](https://github.com/tylerkrupicka))
...
- maybe get multiple postcss processes set up ([@tylerkrupicka](https://github.com/tylerkrupicka))
- add await ([@tylerkrupicka](https://github.com/tylerkrupicka))
- get cssImports working ([@tylerkrupicka](https://github.com/tylerkrupicka))
...
- Update dependency typescript to v4 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency postcss-modules to v3.2.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency @babel/core to v7.11.4 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency pretty-bytes to v5.4.1 ([@renovate-bot](https://github.com/renovate-bot))
...
- fail build if code doesn't transpile ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency postcss-nested to v4.2.3 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency colorette to v1.2.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency babel-plugin-styled-components to v1.11.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency @types/clean-css to v4.2.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency postcss-modules to v3 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency type-fest to v0.16.0 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency postcss-hexrgba to v2.0.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency fast-glob to v3.2.4 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency chokidar to v3.4.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency autoprefixer to v9.8.6 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency typescript to v3.9.7 ([@renovate-bot](https://github.com/renovate-bot))
...
- don't build and files in a `stories/` folder ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- file ignore, no need to include contents for typescript to check ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- fix ignoring files during watch mode ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- don't type-check snippets during build ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix build ([@hipstersmoothie](https://github.com/hipstersmoothie))
- Update jest monorepo ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency postcss to v7.0.32 [#262](https://github.com/intuit/design-systems-cli/pull/262) ([@renovate-bot](https://github.com/renovate-bot) [@hipstersmoothie](https://github.com/hipstersmoothie) [@renovate[bot]](https://github.com/renovate[bot]))

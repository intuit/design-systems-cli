...
- Update proof to latest ([@adierkens](https://github.com/adierkens))
- upgrade typescript to fix build ([@hipstersmoothie](https://github.com/hipstersmoothie))
- upgrade proof -> 0.1.1 ([@hipstersmoothie](https://github.com/hipstersmoothie))

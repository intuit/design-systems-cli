...
- Updating postcss-loader object ([@fattslug](https://github.com/fattslug))
...
- Use resolved location for source-map-loader ([@adierkens](https://github.com/adierkens))
...
- loosen storybook cli range ([@hipstersmoothie](https://github.com/hipstersmoothie))

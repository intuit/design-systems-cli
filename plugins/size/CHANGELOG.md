...
- Add --build-commant option ([@yucho](https://github.com/yucho))
- Edit comments ([@yucho](https://github.com/yucho))
- Implement --merge-base option in size plugin ([@yucho](https://github.com/yucho))
...
- Update dependency diff2html to v3.3.0 ([@renovate-bot](https://github.com/renovate-bot))
- persist size for package ([@GauravKesarwani](https://github.com/GauravKesarwani))
- Update dependency commently to v6.18.3 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency table to v6.0.7 ([@renovate-bot](https://github.com/renovate-bot))
...
- chore(typings): fix some type issues with the new types ([@vfreitas-](https://github.com/vfreitas-))
...
- Update dependency webpack-inject-plugin to v1.5.5 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency commently to v6.2.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency table to v6 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency diff2html to v3.1.12 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency optimize-css-assets-webpack-plugin to v5.0.4 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency mini-css-extract-plugin to v0.11.0 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency commently to v6.0.6 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency diff2html to v3.1.11 ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency commently to v6.0.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency commently to v6.0.1 ([@renovate-bot](https://github.com/renovate-bot))
- fix release - get rid of some old deps ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency @types/webpack-sources to v1 ([@renovate-bot](https://github.com/renovate-bot))
- Revert "Update dependency css-loader to v4" ([@hipstersmoothie](https://github.com/hipstersmoothie))
- Update dependency commently to v5.87.0 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency chokidar to v3.4.2 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency terser-webpack-plugin to v4 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency webpack to v4.44.1 ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency mini-css-extract-plugin to v0.10.0 ([@renovate-bot](https://github.com/renovate-bot))
- Bump version to: v1.10.0 \[skip ci\] ([@hipstersmoothie](https://github.com/hipstersmoothie))
- Update CHANGELOG.md \[skip ci\] ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix lint ([@hipstersmoothie](https://github.com/hipstersmoothie))
- calc size for packages with changed deps too ([@hipstersmoothie](https://github.com/hipstersmoothie))
- only run size for packages changed since last tag ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Update dependency @types/mini-css-extract-plugin to v0.9.1 [#144](https://github.com/intuit/design-systems-cli/pull/144) ([@renovate-bot](https://github.com/renovate-bot) [@renovate[bot]](https://github.com/renovate[bot]))
...
- Update dependency webpack-inject-plugin to v1.5.4  ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency webpack to v4.41.5  ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency mini-css-extract-plugin to v0.9.0  ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency css-loader to v3.4.2  ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency diff2html to v2.12.2  ([@renovate-bot](https://github.com/renovate-bot))
- Update dependency commently to v5.69.1  ([@renovate-bot](https://github.com/renovate-bot))
...
- Update dependency @types/webpack-sources to v0.1.6  ([@renovate-bot](https://github.com/renovate-bot))
...
- fix lint  ([@hipstersmoothie](https://github.com/hipstersmoothie))
- add size config option for private registry  ([@hipstersmoothie](https://github.com/hipstersmoothie))

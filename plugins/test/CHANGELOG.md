...
- update breaking changes from jest 27 ([@sugarmanz](https://github.com/sugarmanz))
...
- Update dependency @types/jest to v26.0.20 ([@renovate-bot](https://github.com/renovate-bot))
